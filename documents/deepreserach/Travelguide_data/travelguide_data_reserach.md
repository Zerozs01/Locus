...
สำหรับแต่ละจังหวัด ให้ข้อมูล 10 หมวดนี้:
...
═══════════════════════════════════════════
8. knowledgeTips (ทิปส์เฉพาะจังหวัด 5-10 รายการ)
═══════════════════════════════════════════
แต่ละรายการประกอบด้วย:
- title: หัวข้อสั้นๆ (เช่น "ช่วงรถติดหนัก")
- content: คำแนะนำเฉพาะจังหวัด 1-3 ประโยค (ภาษาไทย)
- type: "safety" | "season" | "route" | "culture" | "food" | "budget"

═══════════════════════════════════════════
9. supplyPoints (จุดเติมเสบียงสำคัญ 4-12 รายการ)
═══════════════════════════════════════════
แต่ละรายการประกอบด้วย:
- type: "bank" | "gas" | "toilet" | "pharmacy" | "clinic" | "police" | "ev_charger" | "other"
- label: ชื่อจุด/ประเภทจุดบริการ
- area: พื้นที่หรืออำเภอที่พบได้บ่อย (เช่น "อ.เมือง", "ทางหลวงหมายเลข ...")
- note: หมายเหตุการใช้งานสั้นๆ
- openHours: เวลาเปิด-ปิด (ถ้าไม่มีใส่ null)
- mapUrl: ลิงก์แผนที่/แหล่งอ้างอิง (ถ้าไม่แน่ใจใส่ "")

═══════════════════════════════════════════
10. plannerHints (ตัวช่วยต้นทาง-ปลายทางสำหรับทริปแพลนเนอร์)
═══════════════════════════════════════════
- commonOrigins: array ต้นทางยอดนิยม 3-8 จุด (เช่น "กรุงเทพฯ", "สนามบินเชียงใหม่")
- commonDestinations: array ปลายทางยอดนิยม 5-12 จุดในจังหวัด
- transitHubs: array จุดต่อรถ/ท่าเรือ/สถานีหลัก 2-8 จุด
- routeNotes: array ของข้อความสั้น 2-6 ข้อ สำหรับเตือนเรื่องช่วงเวลาเดินทาง/รถหมด/รถเต็ม
...
- ห้ามแต่งหมายเลขฉุกเฉินหรือข้อมูลทางการแพทย์ขึ้นมาเอง ถ้าไม่ชัวร์ให้เว้นว่างหรือใส่ null
