...
const mdPath = path.resolve(__dirname, '../documents/deepreserach/Ecology_data/th_ecology_east_west_2026.json');
...
const seedFiles = [
  'portalSeed_eastWest1.ts',
  'portalSeed_eastWest2.ts',
  'portalSeed_eastWest3.ts'
];
