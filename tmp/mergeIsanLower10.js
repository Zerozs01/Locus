...
const mdPath = path.join(__dirname, '../documents/deepreserach/KnowledgeTips/knowledgeTips_Isan_Lower(10).md');
const mdContent = fs.readFileSync(mdPath, 'utf8');

// Use regex to locate the json blocks. Some markdown files might have multiple json blocks or trailing contents.
let tipsData = {};
