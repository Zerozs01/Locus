...
const mdPath = path.join(__dirname, '../documents/deepreserach/KnowledgeTips/knowledgeTips_Isan_Upper(10).md');
...
if (jsonBlocks.length > 0) {
  ...
  // It might be sheer raw JSON without markdown blocks
  try {
