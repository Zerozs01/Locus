...
export const regionTheme = {
  north: {
    ...
    hoverBorder: 'hover:border-rose-500 hover:border-l-rose-500',
  ...
  northeast: {
    ...
    hoverBorder: 'hover:border-pink-500 hover:border-l-pink-500',
  ...
  central: {
    ...
    hoverBorder: 'hover:border-cyan-500 hover:border-l-cyan-500',
  ...
  west: {
    ...
    hoverBorder: 'hover:border-purple-500 hover:border-l-purple-500',
  ...
  east: {
    ...
    hoverBorder: 'hover:border-green-500 hover:border-l-green-500',
