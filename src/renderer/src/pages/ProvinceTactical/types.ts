...
export interface ProvinceData {
  ...
  safetyIndex: number;
  dailyCost: string;
  attractions: Array<{ id?: number; name: string; type: string; rating: number; description?: string; openHours?: string; price?: string; coordinates?: { lat: number; lng: number }; image?: string; fullImageUrl?: string }>;
